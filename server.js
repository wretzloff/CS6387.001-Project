...
var utdtextbookexchange_app = function() {
    ...
    self.createRoutes = function() {
		...
		self.getRoutes['/thirdPartySalePrice/isbn/:isbn'] = function(request, response) 
		{
			...
			thirdPartyPriceInfo.push({price: '51.47', source: 'Amazon', link: 'https://www.amazon.com/Starting-Control-Structures-through-Objects/dp/0133778819/ref=sr_1_1?ie=UTF8&qid=1487534860&sr=8-1&keywords=9780133778816'});
